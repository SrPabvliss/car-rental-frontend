...
function __VLS_template() {
    ...
    const __VLS_12 = __VLS_resolvedLocalAndGlobalComponents.DotFilledIcon;
    /** @type { [typeof __VLS_components.DotFilledIcon, ] } */
    // @ts-ignore
    const __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12({ ...{ class: ("h-4 w-4 fill-current") }, }));
    const __VLS_14 = __VLS_13({ ...{ class: ("h-4 w-4 fill-current") }, }, ...__VLS_functionalComponentArgsRest(__VLS_13));
