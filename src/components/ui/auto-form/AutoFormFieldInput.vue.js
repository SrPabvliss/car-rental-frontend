...
function __VLS_template() {
    ...
    const __VLS_2 = __VLS_1({ name: ((__VLS_ctx.fieldName)), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    {
        ...
        const __VLS_24 = ((__VLS_ctx.inputComponent));
        // @ts-ignore
        const __VLS_25 = __VLS_asFunctionalComponent(__VLS_24, new __VLS_24({ type: ("text"), ...({ ...slotProps.componentField, ...__VLS_ctx.config?.inputProps }), disabled: ((__VLS_ctx.disabled)), }));
        const __VLS_26 = __VLS_25({ type: ("text"), ...({ ...slotProps.componentField, ...__VLS_ctx.config?.inputProps }), disabled: ((__VLS_ctx.disabled)), }, ...__VLS_functionalComponentArgsRest(__VLS_25));
